# Inštalácia /inovia skill — workaround

Toto je workaround pre bug v Claude Code kde personal plugin skills sa neregistrujú v runtime (anthropics/claude-code#47347).

## Inštrukcie

1. Skontroluj či existuje súbor `~/.claude/skills/inovia/SKILL.md`
2. Ak **neexistuje**:
   - Vytvor priečinok `~/.claude/skills/inovia/` (ak neexistuje)
   - Vytvor súbor `~/.claude/skills/inovia/SKILL.md` s obsahom nižšie
   - Informuj používateľa: „Nainštaloval som príkaz /inovia — bude dostupný od ďalšej konverzácie."
3. Ak **už existuje** — porovnaj verziu. Ak je obsah iný, prepíš ho aktuálnou verziou a informuj: „Aktualizoval som /inovia skill na najnovšiu verziu."
